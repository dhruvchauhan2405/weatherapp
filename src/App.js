...
function App() {
  ...
  const formatBackground = () => {
    if (!weather)
      return "bg-gradient-to-br from-teal-600 via-teal-800 to-teal-950";
  ...
  return (
    <div
      className={`mx-auto max-w-screen-xxl  bg-gradient-to-br  h-fit shadow-xl shadow-gray-400 ${formatBackground()}`}
    >
      <Navbar></Navbar>
      ...
      <div className="flex font-bold text-slate-200 items-center justify-center">
        ...
        Devloped by Dhruv Singh Chauhan
